...
-- Indexes
CREATE UNIQUE INDEX "auth_user_id_index" ON "account" USING btree ("authUserId");
CREATE UNIQUE INDEX "user_profile_index" ON "account" USING btree ("userProfileId");
CREATE UNIQUE INDEX "wallet_index" ON "account" USING btree ("walletId");
...
--
-- Class ConfigKey as table config_key
--
...
--
-- Class ConfigSnapshotVersion as table config_snapshot_version
--
...
-- Indexes
CREATE UNIQUE INDEX "contact_user_index" ON "contact" USING btree ("accountId");

--
-- Class DailyStepTelemetry as table home_daily_step_telemetry
--
...
--
-- Class OtpVerificationResult as table none
--
CREATE TABLE "none" (
    "id" bigserial PRIMARY KEY,
...
--
-- Class RemoteLocalizationAuditLog as table remote_localization_audit_log
--
...
--
-- Class RemoteLocalizationRelease as table remote_localization_release
--
...
--
-- Class SecurityEvent as table security_event
--
...
--
-- Class TargetingOverride as table targeting_override
--
...
--
-- Class Wallet as table wallet
--
CREATE TABLE "wallet" (
    "id" uuid PRIMARY KEY DEFAULT gen_random_uuid(),
    "cashBalance" double precision NOT NULL DEFAULT 0,
    "connectBalance" bigint NOT NULL DEFAULT 0
);

--
-- Class WalletTransactions as table wallet_transactions
--
CREATE TABLE "wallet_transactions" (
    ...
    "_walletTransactionsWalletId" uuid
);
...
--
-- Foreign relations for "contact" table
--
ALTER TABLE ONLY "contact"
    ADD CONSTRAINT "contact_fk_0"
...
--
-- Foreign relations for "targeting_override" table
--
...
ALTER TABLE ONLY "wallet_transactions"
    ...
    FOREIGN KEY("_walletTransactionsWalletId")
    REFERENCES "wallet"("id")
    ON DELETE NO ACTION
    ON UPDATE NO ACTION;
