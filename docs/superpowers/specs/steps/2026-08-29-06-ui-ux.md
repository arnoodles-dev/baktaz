...
```text
Step Data Permission Needed

To track your daily steps, allow access to
your step data in your device settings.
...
```text
Step Data Temporarily Unavailable
...
# 15. Steps Integration Checklist UI
