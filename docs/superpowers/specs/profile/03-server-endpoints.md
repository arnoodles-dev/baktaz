# Profile Header & Lifetime Stats — Server Endpoints

> **Document Version:** 1.0  
> **Date:** 2026-08-29  
> **Parent Spec:** `docs/superpowers/specs/profile/00-overview.md`

---

## 1. New: IAccountRepository Interface

**File:** `baktaz_server/lib/src/features/account/domain/interface/i_account_repository.dart`
...
## 2. New: AccountRepository Implementation

**File:** `baktaz_server/lib/src/features/account/data/repository/account_repository.dart`
...
## 2. AccountChallengeStatsRepository Stub

**File:** `baktaz_server/lib/src/features/account/data/repository/account_challenge_stats_repository.dart`
...
## 5. Generator.yaml Configuration (FileRepository)
...
fileRepository:
  default: local
  local:
    path: /tmp/baktaz-files
  s3:
    bucket: baktaz-avatars
    region: ap-southeast-1
```

For production, switch `default: s3` and configure AWS credentials.
