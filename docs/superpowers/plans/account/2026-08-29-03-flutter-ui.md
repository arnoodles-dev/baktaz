...
- Zero hardcoded UI strings — all text sourced from `context.i18n.account.*` (snake_case) Slang keys.
- Spacing strictly uses `BaktazSpacing.*` constants and `SizedBox` widgets.
